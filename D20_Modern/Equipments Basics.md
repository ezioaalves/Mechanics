...
### The Black Market
Sometimes a character wants to obtain an object without going through the hassle of getting a license first. Almost anything is available on the black market. Knowledge (local) checks can be used to locate a black market merchant. The DC is based on the location in question: 15 to find a black market merchant in a big city, or 20, 25, or higher in small towns and rural areas.
Objects purchased on the black market are more expensive than those purchased legally. Add the black market purchase DC modifier from Table: Restricted Objects to the object’s purchase
DC.
...
The result of the check determines whether and how quickly Department-7 can provide the hero with the requested equipment. With a success, the object is issued to the hero.
Generally, it takes 24 hours to obtain an object through requisition, but if the object is especially common, or if the hero beats the check DC by 5 or more, it is available in 1d4 hours.
...
**Table - Concealing Weapons and Objects Condition**

| Size of weapon or object                                 | Example                                | Modifier      |
| -------------------------------------------------------- | -------------------------------------- | ------------- |
| Rine or smaller                                          | Credit card, single page document      | +12           |
| Siminutive                                               | A couple rounds of ammo or a detonator | +8            |
| TIny                                                     | Brass knuckles or deck of cards        | +4            |
| Small                                                    | A little pistol or bigger knife        | +0            |
| Medium-size                                              | an SMG or short sword                  | -4            |
| Large                                                    | an automatic rifle or small tool set\| | -8            |
| Huge or larger                                           | Rocket Launchers or ...                | can't conceal |
| Clothing is tight or small                               |                                        | -4            |
| Clothings is especially loose or bulky                   |                                        | +2            |
| Clothing is speciafically modified for concealing object |                                        | +2            |
...
Spot DC	=	10	+	Target's Sleight of Hand skill modifier	+	Modifiers from Table: Concealing Weapons and Objects
...
Tremendous Strength: For Strength scores not listed, find the Strength score between 20 and 29 that has the same ones digit as the creature's Strength score. Multiply the figures x4 if the creature's Strength is in the 30s, x16 (4x4) if the creature's Strength is in the 40s, x64 (16x4) if the creature's Strength is in the 50s, x256 (64x4) if the creature's Strength is in the 60s, and so on.
