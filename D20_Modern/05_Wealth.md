...
>
> Source: `Sourcebooks/OSR/modernsrd.pdf` p.14-15. Imported verbatim; tables marked `TODO` still need a manual grid pass.
...
A Wealth check is a 1d20 roll plus a character’s current Wealth bonus. The Wealth bonus is fluid. It increases as a character gains Wealth and decreases as the character makes purchases. If the character succeeds on the Wealth check, the character gains the object. If the character fails, he or she can’t afford the object at the time. If the character’s current Wealth bonus is equal to or greater than the DC, the character automatically succeeds. If the character successfully purchases an object or service with a purchase DC that’s higher than his or her current Wealth bonus, the character’s Wealth bonus decreases.

### Wealth and the Starting Hero

A newly created 1st-level character’s Wealth bonus is +0 plus: • Wealth provided by the character’s starting occupation. • Bonus from the Windfall feat, if taken. • 2d4 die roll. • +1 for having 1 to 4 ranks in the Profession skill.
...
reduces his or her current Wealth bonus by an additional 1 point. A character’s Wealth bonus only goes down if he or she successfully buys an object or service. If the character attempts to buy something and the check fails, his or her Wealth bonus is unaffected.
