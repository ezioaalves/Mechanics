...
**Benefit**: class="d20table" style="width:300px;float:right;"
+**Table: Population Modifiers**
-style="color:white;"
!Population
!DC
!Checks
...
The DC of the check and the number of checks required to track down your quarry depends on the community population and the conditions (see table: Urban Tracking Difficulty). 
 class="d20table" style="width:400px;"
+**Table: Urban Tracking Difficulty**
-style="color:white;"
!Condition
!DC Modifier
-
